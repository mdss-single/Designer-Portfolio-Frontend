//yarn add gulp gulp-watch gulp-uglify gulp-stylus gulp-sourcemaps gulp-rigger gulp-plumber gulp-clean-css gulp-concat gulp-autoprefixer rimraf browser-sync
...
gulp.task('style-full:build', function() {
	gulp.src(path.src.css)
		.pipe(plumber())
		.pipe(stylus())
		.pipe(autoprefixer({
